            ...
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="font-body text-ns-muted text-[12px] mt-0.5 m-0">
                  Su sistema cubre el {Math.round(coverage)}% de su consumo eléctrico. El{" "}
                  {100 - Math.round(coverage)}% restante se toma de la red.
                </p>
              </div>
              <span
            ...
            <div className="h-3 w-full bg-ns-border rounded-full overflow-hidden">
              <div
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(90deg, #1B2A4A 0%, #F28C28 100%)",
                }}
              />
            </div>
          </div>
