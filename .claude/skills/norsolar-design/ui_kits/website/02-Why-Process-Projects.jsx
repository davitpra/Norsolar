...
function WhySection() {
  ...
  return (
    <section className="ns-section ns-why" id="nosotros">
...
// ============== PROCESS ==============
function ProcessSection({ onCotizar }) {
  const steps = [
  ...
  return (
    <section className="ns-section ns-section-alt ns-process">
      <div className="ns-container">
        ...
        <div className="ns-process-grid">
          {steps.map(s => (
            <article key={s.n} className="ns-process-step" style={{ backgroundImage: `url(${s.img})` }}>
        ...
        <div className="ns-process-foot">
          <div className="ns-process-pager">
            <button className="ns-btn-ghost-dark">← Anterior</button>
            <button className="ns-btn-ghost-dark">Siguiente →</button>
          </div>
...
function ProjectsSection() {
  ...
  return (
    <section className="ns-section ns-projects" id="proyectos">
      <div className="ns-container">
        ...
        <div className="ns-projects-grid">
          {items.map(p => (
            <article key={p.title} className="ns-project-card">
              ...
              <h3>{p.title}</h3>
              <p>{p.desc}</p>
              <a href="#" className="ns-link">Ver más →</a>
            </article>
          ))}
        </div>
      </div>
...
window.NSWhy = WhySection;
window.NSProcess = ProcessSection;
window.NSProjects = ProjectsSection;
