...
<script>
  tailwind.config = {
    theme: {
      extend: {
        colors: {
          'ns-orange': '#F28C28', 'ns-orange-hover': '#E07B1A', 'ns-orange-soft': '#FDE4CB',
          'ns-navy': '#1B2A4A', 'ns-navy-deep': '#0F1A2E', 'ns-muted': '#6B7280',
          'ns-bg-alt': '#F7F8FA', 'ns-border': '#E5E7EB', 'ns-success': '#22C55E',
        },
        fontFamily: {
